...
/**
 * We use Handlebars for autogenerated files. This includes 
 * config files, client libraries, and hadlers. This module provides
 * helper functions and a main for finding and rendering templates.
 */

/**
 * Only SELECT statements are eligible for a GET request. Non-SELECTs are returned
 * as the {{else}} option.
 * 
 * One or many `resultsets` can be returned by a query. So we need to be able to
 * handle the possibility of mutliple results (hence "all" instead of "if").
 */
...
/**
  * Map iteration.
  * 
  * Handlebars helper (not specific to embrace-sql). 
 */
